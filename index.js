...
*/
console.log('Task 1b: ', createMenuItem("pizza",5,"lunch"), createMenuItem("eggs",2,"Breakfest"), createMenuItem("nuts",2,"lunch"));
...
const reviews = [
    ...
    {name: "Reyna", rating: 3.5, feedback: "great eats!"},
]
...
*/
reviews.push({name: 'Brit', rating: 5, feedback: 'this place is amazing, will come back!'})
